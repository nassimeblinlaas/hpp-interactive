			...
			qProj_ (problem.robot ()->configSize ())
		{
			...
			//else{
				...
				while(1){
					...
					SixDOFMouseDriver::mutex_.lock();
					p.applyConfiguration("scene_hpp_/curseur", 
							SixDOFMouseDriver::transformation_);	
					SixDOFMouseDriver::mutex_.unlock();
					p.refresh();
				}
			//}
...
//				getData();
//				//if (unique) break;
//				//// permet de couper le programme après la première lecture pour debug
//				//unique = true;
//
//
//				/////////////////////////////////////////////////////////
...
//				if (pos[2]+transformation.translation()[2]<0) pos[2] = 0;
//				if (pos[2]+transformation.translation()[2]>1) pos[2] = 0;
...
//
//				// TODO : convertir mat rot en quaternion
//				(*actual_configuration_ptr_)[3] = 0;
//				(*actual_configuration_ptr_)[4] = 0;
//				(*actual_configuration_ptr_)[5] = 0;
//				(*actual_configuration_ptr_)[6] = 1;
//				//cout << "act conf" << (*actual_configuration_ptr_) << endl;
//
//				/////////////////////////////////////////////////////////
//				// rotation
//				rot[0] = (float)(Planner::deviceValuesNormalized_[3]* M_PI);
//				rot[1] = (float)(Planner::deviceValuesNormalized_[4]* M_PI);
//				rot[2] = (float)(Planner::deviceValuesNormalized_[5]* M_PI);
