...
#ifndef HPP_INTERACTIVE_DEPRECATED_HH
# define HPP_INTERACTIVE_DEPRECATED_HH
...
//  void foo () HPP_INTERACTIVE_DEPRECATED;
//
// Tagging a type as deprecated:
//  class Foo {};
//  typedef Foo Bar HPP_INTERACTIVE_DEPRECATED;
//
// Tagging a variable as deprecated:
//  int a HPP_INTERACTIVE_DEPRECATED = 0;
//
...
# ifdef __GNUC__
#  define HPP_INTERACTIVE_DEPRECATED __attribute__ ((deprecated))
# else
#  if defined(_MSC_VER) && !defined(__INTEL_COMPILER)
#   define HPP_INTERACTIVE_DEPRECATED __declspec (deprecated)
#  else
// If the compiler is not recognized, drop the feature.
#   define HPP_INTERACTIVE_DEPRECATED /* nothing */
#  endif // __MSVC__
# endif // __GNUC__

#endif //! HPP_INTERACTIVE_DEPRECATED_HH
